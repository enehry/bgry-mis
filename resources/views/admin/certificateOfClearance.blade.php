          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="barangayClearance">Mode of Payment</h5>
              ...
              <div class="modal-body">
                <div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="date" value="{{$clearance->date}}" disabled>
                  </div>
                  <div class="form-group">
                    <label>Purpose</label>
                    <textarea class="form-control" placeholder="Enter Payment Details" name="details" disabled>{{$clearance->purpose}}</textarea>
                  </div>
                  <div class="form-group">
