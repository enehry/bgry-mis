            ...
            <div class="card-body m-5" id="printThis">
              <div class="d-flex flex-wrap justify-content-around" style="border-bottom:1px solid blue">
                <div class="text-center">
                  ...
                  <img src="{{$settings->barangay_logo ?  $settings->barangay_logo : asset('images/-image.png')}}" class="img-fluid" width="100" style="padding-bottom: 15%">
                  @endforeach
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                  @foreach($setting as $settings)
                  <img src="{{$settings->barangay_logo ? $settings->barangay_logo : asset('images/-image.png')}}" class="img-fluid" width="100">
                  @endforeach
                </div>
              </div>
              <div class="row mt-2">
                ...
                <div class="col-md-12">
                  ...
                  <h6 class="mt-3" style="text-indent: 40px;">This is to certify that <span class="fw-bold" style="font-size:15px">{{$cer->first_name}} {{$cer->last_name}}</span>, of legal age, <span class="fw-bold" style="font-size:15px">{{$cer->gender}}</span>,<span class="fw-bold" style="font-size:15px">{{$cer->civil_status}}</span> is a permanent resident of
                  ...
                  <h6 class="mt-3" style="text-indent: 40px;">Given this on <span class="fw-bold" style="font-size:15px"><?= date('F j, Y, g:i a') ?>.</span></h6>
                ...
                <div class="col-md-12">
                  <div class="p-3 text-right mr-3">
                    ...
                    <h6 class="fw-bold mb-0 text-uppercase">
                      {{-- {{$officials->name}} --}}_______________________
                    </h6>
                    {{-- @endforeach --}}
                    <p class="mr-2">
                      {{-- {{$officials->position}} --}}PUNONG BARANGAY
                    </p>
                  </div>
                </div>
