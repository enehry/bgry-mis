...
<body class="dark scroll">
  <div class="wrapper vh-100">
    <div class="row align-items-center h-100">
      ...
      <form method="POST" action="/adminLogin/auth" class="col-lg-4 col-md-4 col-10 mx-auto text-center">
        <h1 class="h1 mb-3">Welcome Administrator</h1>
        @csrf
        @if(session()->has('fail'))
        ...
        <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="/">
          ...
          <img src="{{$settings->barangay_logo ? asset ($settings->barangay_logo) : asset('no/-image.png')}}" class="img-fluid" width="100" style="padding-bottom: 15%">
          @endforeach
        </a>
